...
CREATE OR REPLACE TYPE GRADO_TYP AS OBJECT (
    ...
    MINUTOS     INTEGER,
    SEGUNDOS    INTEGER,
    CONSTRUCTOR FUNCTION    GRADO_TYP (GRADOS INTEGER, MINUTOS INTEGER, SEGUNDOS INTEGER) RETURN SELF AS RESULT,
...
CREATE OR REPLACE TYPE BODY GRADO_TYP IS
    CONSTRUCTOR FUNCTION GRADO_TYP (GRADOS INTEGER, MINUTOS INTEGER, SEGUNDOS INTEGER)
